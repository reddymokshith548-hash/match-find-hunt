...
const SignUp = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-accent/5 dark:bg-gradient-to-br dark:from-background dark:via-background/95 dark:to-secondary/8 flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md hover-tilt relative bg-card/80 backdrop-blur-sm border-accent/20 shadow-elegant">
        <CardHeader className="text-center space-y-4">
          ...
          <div>
            <CardTitle className="text-2xl font-bold text-foreground">Join FindBaee</CardTitle>
        ...
        <CardContent className="space-y-6">
          ...
          <form onSubmit={handleEmailSignUp} className="space-y-4">
            ...
            <Button
              type="submit"
              className="w-full hover-3d transition-all duration-300 bg-accent"
              disabled={loading}
              size="lg"
            >
