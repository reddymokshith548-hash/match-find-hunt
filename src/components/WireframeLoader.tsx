...
const WireframeLoader = ({ onComplete, duration = 6800 }: WireframeLoaderProps) => {
  ...
  return (
    <div
      className={`fixed inset-0 z-[9999] bg-white flex items-center justify-center overflow-hidden transition-opacity duration-[1100ms] ease-in-out ${
    ...
    >
      ...
      <div
        ...
        style={{ animation: "wf-fade-in 1s ease-out 1.4s forwards" }}
      >
        ...
        <div className="w-32 h-[2px] bg-neutral-200 overflow-hidden">
          <div
            ...
            style={{
              transform: "scaleX(0)",
              animation: "wf-progress 4.5s cubic-bezier(0.4,0,0.2,1) 1.6s forwards",
            }}
          />
        </div>
      </div>

      {/* Blueprint lines - drawn slowly outward, joining the corners */}
      <svg
        className="absolute inset-0 w-full h-full pointer-events-none"
        preserveAspectRatio="none"
      >
        {/* Cardinal lines from center */}
        <line
          x1="50%" y1="50%" x2="50%" y2="0"
          stroke="hsl(0 0% 80%)" strokeWidth="1"
          style={{
            strokeDasharray: 2000, strokeDashoffset: 2000,
            animation: "wf-draw 3s cubic-bezier(0.65,0,0.35,1) 2s forwards",
          }}
        />
        <line
        ...
        <line
          ...
          style={{
            ...
            animation: "wf-draw 3s cubic-bezier(0.65,0,0.35,1) 2.2s forwards",
          }}
        />
        <line
        ...
        <line
          ...
          style={{
            ...
            animation: "wf-draw 3.2s cubic-bezier(0.65,0,0.35,1) 2.6s forwards",
          }}
        />
        <line
        ...
        <line
          ...
          style={{
            strokeDasharray: 3500, strokeDashoffset: 3500,
            animation: "wf-draw 3.2s cubic-bezier(0.65,0,0.35,1) 2.8s forwards",
          }}
        />
        <line
        ...
        {/* Outer frame — draws last, joining everything together */}
        <rect
          x="0.5" y="0.5" width="99.5%" height="99.5%"
          fill="none" stroke="hsl(0 0% 75%)" strokeWidth="1"
          pathLength={1000}
          style={{
            strokeDasharray: 1000, strokeDashoffset: 1000,
            animation: "wf-draw 2.4s cubic-bezier(0.65,0,0.35,1) 5.4s forwards",
          }}
        />
      </svg>
      ...
      <div className="relative">
        ...
        <div
          ...
          style={{
            ...
            animation: "wf-rise 1.6s cubic-bezier(0.22,1,0.36,1) 0.2s forwards",
          }}
        >
          Lexach
        </div>
        ...
        <div
          ...
          style={{ animation: "wf-snap-tl 0.6s cubic-bezier(0.4,0,0.2,1) 1.6s forwards" }}
        />
        <div
          className="absolute -top-2 -right-2 w-5 h-5 border-t-2 border-r-2 border-red-600 opacity-0"
          style={{ animation: "wf-snap-tr 0.6s cubic-bezier(0.4,0,0.2,1) 1.6s forwards" }}
        />
        <div
          className="absolute -bottom-2 -left-2 w-5 h-5 border-b-2 border-l-2 border-red-600 opacity-0"
          style={{ animation: "wf-snap-bl 0.6s cubic-bezier(0.4,0,0.2,1) 1.8s forwards" }}
        />
        <div
          className="absolute -bottom-2 -right-2 w-5 h-5 border-b-2 border-r-2 border-red-600 opacity-0"
          style={{ animation: "wf-snap-br 0.6s cubic-bezier(0.4,0,0.2,1) 1.8s forwards" }}
        />
        <div
          className="absolute top-1/2 -left-4 w-2 h-px bg-red-600 opacity-0"
          style={{ animation: "wf-fade-in 0.6s ease-out 2s forwards" }}
        />
        <div
