...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-accent/20 overflow-hidden perspective-container">
      ...
      <div 
        className="absolute top-20 left-10 w-6 h-6 bg-primary/20 rounded-full floating-element animate-pulse-glow"
        style={{
          transform: `translate(${mousePosition.x * 0.02}px, ${mousePosition.y * 0.02}px)`,
        }}
      />
      <div 
        className="absolute top-1/3 right-20 w-4 h-4 bg-secondary/30 rounded-full floating-element"
        style={{
      ...
      />
      <div 
        className="absolute bottom-1/4 left-1/4 w-8 h-8 bg-primary/10 rounded-full floating-element animate-scale-pulse"
        style={{
      ...
      {/* Floating Icons */}
      <Sparkles 
        className="absolute top-1/4 right-1/3 w-6 h-6 text-secondary/40 floating-element" 
        style={{
      ...
      />
      <Rocket 
        className="absolute bottom-1/3 right-10 w-8 h-8 text-primary/30 floating-element animate-tilt" 
        style={{
      ...
      />
      <Star 
        className="absolute top-1/2 left-20 w-5 h-5 text-secondary/50 floating-element animate-pulse-glow" 
        style={{
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left animate-slide-up">
            ...
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed opacity-0 animate-slide-up" style={{ animationDelay: '0.2s', animationFillMode: 'forwards' }}>
            ...
            {/* Stats */}
            <div className="flex flex-col sm:flex-row gap-8 text-center lg:text-left opacity-0 animate-slide-up" style={{ animationDelay: '0.6s', animationFillMode: 'forwards' }}>
              ...
              <div className="flex items-center gap-2 hover-3d group">
                <div className="w-10 h-10 bg-secondary/10 rounded-lg flex items-center justify-center group-hover:bg-secondary/20 transition-colors animate-pulse-glow" style={{ animationDelay: '1s' }}>
          ...
          {/* Right Column - Image */}
          <div className="relative opacity-0 animate-slide-up" style={{ animationDelay: '0.3s', animationFillMode: 'forwards' }}>
            ...
            {/* Floating elements */}
            <div 
              className="absolute -top-4 -right-4 w-16 h-16 bg-secondary rounded-full flex items-center justify-center animate-float hover-3d cursor-pointer animate-pulse-glow"
              style={{
            ...
            <div 
              className="absolute -bottom-4 -left-4 w-12 h-12 bg-primary rounded-full flex items-center justify-center animate-float-slow hover-3d cursor-pointer"
              style={{
                transform: `translate(${mousePosition.x * -0.01}px, ${mousePosition.y * -0.01}px)`,
                animationDelay: '2s'
              }}
